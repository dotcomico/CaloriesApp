...
public class ProductStorageManager {
	...
	public void addProductAndSave(Product newProduct) { // זה צריך להיות שייך למחלקה נוספת ניהול המוצרים (כמו שיש ניהול
														// אחסון מוצרים שנצרכו וגם ניהול מוצרים שנצרכו
		if (newProduct == null) {
